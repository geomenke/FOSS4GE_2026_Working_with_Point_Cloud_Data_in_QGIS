...
#### Software
Software:
To get the most out of this workshop you are encouraged to install the latest stable release of QGIS (v 4.0.x). Do this in the week prior to the conference. There are several important enhancements to working with point clouds which are included in QGIS 4.x. 
...
### Instructors
This workshop has been developed by Kurt Menke and Martin Dobias for the FOSS4GE Conference 2026, in Timișoara, Romania from 29 June to 3 July 2026.
